...
import knowledge1.reflect.Addition;
import knowledge1.reflect.MathOperation;
import knowledge1.reflect.Subtraction;

import java.util.Scanner;

/**
 * @author: lijinhao
 * @date: 2022/01/19 15:27
 */
...
public class count {
    ...
    public static void case2() throws Exception{
        ...
        mathOperation = (MathOperation) Class.forName("knowledge1.reflect." + op).newInstance();
